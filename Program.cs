...
namespace fantasygame
{
    static class Program
    {
        ...
        {
            int playerHealth = 5000; // sätt spelarens starthälsa
            ...
            enemies.Add(new Warrior("Badonka slayer"));
            enemies.Add(new Warrior("Uruk-Hai"));
            ...
            while (playerHealth > 0)
            {
                ...
                switch (input)
                {
                    case "1": // Attackera en viss fiende
                        ...
                        // ge fienden skada:
                        int damage = 200 + random.Next(0, 20);
                ...
                {
                    Console.WriteLine("YOU'RE THE MASTER OF MIDDLE EARTH CONGRATULATIONS MOTHER FUCKER");
                }
